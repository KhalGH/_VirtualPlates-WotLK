...
local TotemPlates = me.TotemPlates -- Defined in Totems folder
local globalYoffset = me.globalYoffset -- Defined in _VirtualPlates.Customize.lua
local IsNamePlate = me.IsNamePlate -- Defined in _VirtualPlates.Customize.lua
local CustomizePlate = me.CustomizePlate -- Defined in _VirtualPlates.Customize.lua
local distanceLimit = math.min(tonumber(GetCVar("nameplateDistance")) or 41, 100) -- Distance at which nameplates reach minimum scale
...
do
	...
	local function SetupTotemPlate(Plate)
		...
		Plate.totemDelay = CreateFrame("Frame")
	end
