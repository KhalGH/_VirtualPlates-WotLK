...
if C_NamePlate and C_NamePlate.GetNamePlatesDistance then
	...
	_VirtualPlates.L = setmetatable( {
		CONFIG_DESC = 	"Configura la forma en que _VirtualPlates escala los nameplates.\n" ..
					  	...
					  	"Autor: Saiket\nVersión mejorada por |cffc41f3bKhal|r",
		...
		CONFIG_SCALEFACTOR = "Distancia Umbral de Escalado",
		CONFIG_SCALEFACTOR_DESC = "Los nameplates más cercanos que esta distancia se mostrarán con su tamaño por defecto, y se reducirán gradualmente a medida que aumente la distancia por encima del umbral.",
	...
	_VirtualPlates.L = setmetatable( {
		...
		CONFIG_SCALEFACTOR = "Distancia de Normalización de Escala",
		CONFIG_SCALEFACTOR_DESC = "Los nameplates a esta distancia de la cámara tendrán escala normal",
		CONFIG_SLIDER_FORMAT = "%.2f",
		CONFIG_SLIDERYARD_FORMAT = "%dm",
		CONFIG_TITLE = "_|cffCCCC88VirtualPlates|r",
	}, { __index = _VirtualPlates.L; } );
