...
if C_NamePlate and C_NamePlate.GetNamePlatesDistance then
	...
	_VirtualPlates.L = setmetatable( {
		...
		CONFIG_SCALEFACTOR = "Abstand für Skalierungsschwelle",
		CONFIG_SCALEFACTOR_DESC = "Nameplates, die näher als dieser Abstand sind, werden in Standardgröße angezeigt. Darüber hinaus schrumpfen sie allmählich.",
	...
	_VirtualPlates.L = setmetatable( {
		...
		CONFIG_SCALEFACTOR = "Distanz zur Skalierungsnormalisierung",
