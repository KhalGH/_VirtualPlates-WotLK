...
----------------------------- API -----------------------------
local ipairs, unpack, select, math_floor, CreateFrame, UnitCastingInfo, UnitChannelInfo, UnitName, UnitIsUnit, UnitReaction =
      ipairs, unpack, select, math.floor, CreateFrame, UnitCastingInfo, UnitChannelInfo, UnitName, UnitIsUnit, UnitReaction
...
me.NP_WIDTH = NP_WIDTH -- reference for _VirtualPlates.lua
me.NP_HEIGHT = NP_HEIGHT -- reference for _VirtualPlates.lua
...
local nameplateMinLevel = 1 -- Minimum unit level to show its nameplate
me.globalYoffset = globalYoffset -- reference for _VirtualPlates.lua
me.nameplateMinLevel = nameplateMinLevel -- reference for _VirtualPlates.lua
-- Name Text
