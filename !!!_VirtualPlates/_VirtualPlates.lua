...
local globalYoffset = me.globalYoffset -- Defined in _VirtualPlates_Customize.lua
local texturePath = me.texturePath -- Defined in _VirtualPlates_Customize.lua
local nameText_colorR, nameText_colorG, nameText_colorB = unpack(me.nameText_color) -- Defined in _VirtualPlates_Customize.lua
local targetGlow_alpha = me.targetGlow_alpha -- Defined in _VirtualPlates_Customize.lua
local mouseoverGlow_alpha = me.mouseoverGlow_alpha -- Defined in _VirtualPlates_Customize.lua
local CustomizePlate = me.CustomizePlate -- Defined in _VirtualPlates_Customize.lua
...
do
	...
	local function SetupTotemPlate(Plate) -- by Khal
