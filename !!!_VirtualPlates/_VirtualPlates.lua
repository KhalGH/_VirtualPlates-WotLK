...
function me.Frame:ADDON_LOADED ( Event, AddOn )
	if ( AddOn == AddOnName ) then
		...
		print("_|cffCCCC88VirtualPlates|r enhanced version by |cffc41f3bKhal|r")
	end
end
...
SLASH_VPDISTANCE1 = "/vpdistance"
SlashCmdList["VPDISTANCE"] = function()
